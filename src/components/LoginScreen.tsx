  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto overflow-hidden relative">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsl(22,85%,75%), transparent 65%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsl(340,60%,75%), transparent 65%)",
      ...
      <div className="relative flex flex-col h-full px-6 py-8 justify-between">
        ...
        <form
          ...
          className="flex flex-col gap-4 animate-slide-up stagger-2"
        >
          <div>
            <label
            ...
            <div className="relative">
              ...
              <input
                ...
                onFocus={(e) =>
                  (e.target.style.borderColor = "hsl(22,85%,62%)")
                }
          ...
          {error && (
            ...
            >
              ...
              <span
                className="text-sm"
                style={{ color: "hsl(0,65%,45%)", fontWeight: 600 }}
              >
                {error}
              </span>
            </div>
