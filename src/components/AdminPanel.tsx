...
import { User, listUsers, createUser, deleteUser } from "@/lib/api";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-4 py-4">
        {/* Alerts */}
        {error && (
          <div className="flex items-center gap-2 px-4 py-3 rounded-2xl mb-3 animate-fade-in"
        ...
        {success && (
          <div className="flex items-center gap-2 px-4 py-3 rounded-2xl mb-3 animate-fade-in"
            style={{ background: "hsl(140,50%,93%)" }}>
        ...
        {showForm && (
          <form
            ...
            className="bg-white rounded-3xl p-4 mb-4 animate-slide-up"
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap mb-4">
              {AVATARS.map((av) => (
                <button
                  ...
                  style={{
                    background: form.avatar === av ? "hsl(22,85%,62%)" : "hsl(35,45%,92%)",
                ...
                <div className="flex gap-2">
                  {ROLES.map((r) => (
                    <button
                      ...
                      style={{
                        background: form.role === r.value ? "hsl(22,85%,62%)" : "hsl(35,45%,92%)",
                        color: form.role === r.value ? "white" : "hsl(25,30%,35%)",
                        fontWeight: 600,
                      }}
                    >
                      {r.label}
            ...
            <button
              ...
              style={{
                background: submitting ? "hsl(22,40%,75%)" : "hsl(22,85%,62%)",
                fontWeight: 700,
              }}
            >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {u.role === "admin" && (
                      <span className="text-[10px] px-1.5 py-0.5 rounded-md flex-shrink-0"
                        style={{ background: "hsl(22,85%,92%)", color: "hsl(22,85%,45%)", fontWeight: 700 }}>
                        ADMIN
                      </span>
                    )}
                  </div>
